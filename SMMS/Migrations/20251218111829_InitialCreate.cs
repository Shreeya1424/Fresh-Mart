        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    PincodeNumber = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StoreOwners_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalDeliveriesCompleted = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "UserId");
                    table.ForeignKey(
                        name: "FK_DeliveryStaffs_Zones_ZoneId",
                        column: x => x.ZoneId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LowStockValue = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    StoreOwnerId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "CategoryId");
                    table.ForeignKey(
                        name: "FK_Products_StoreOwners_StoreOwnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreProfiles", x => x.StoreId);
                    table.ForeignKey(
                        name: "FK_StoreProfiles_StoreOwners_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "StoreOwners",
                        principalColumn: "StoreOwnerId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeliveryStaffStaffId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryStaffAssignments", x => x.AssignmentId);
                    table.ForeignKey(
                        name: "FK_DeliveryStaffAssignments_DeliveryStaffs_DeliveryStaffStaffId",
                        column: x => x.DeliveryStaffStaffId,
                        principalTable: "DeliveryStaffs",
                        principalColumn: "StaffId");
                    table.ForeignKey(
                        name: "FK_DeliveryStaffAssignments_DeliveryStaffs_StaffId",
                        column: x => x.StaffId,
                        principalTable: "DeliveryStaffs",
                        principalColumn: "StaffId");
                    table.ForeignKey(
                        name: "FK_DeliveryStaffAssignments_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderTrackingHistories", x => x.TrackingId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeedbackTargetType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryStaffAssignments_DeliveryStaffStaffId",
                table: "DeliveryStaffAssignments",
                column: "DeliveryStaffStaffId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryStaffAssignments_OrderId",
                table: "DeliveryStaffAssignments",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryStaffAssignments_StaffId",
                table: "DeliveryStaffAssignments",
                column: "StaffId");
